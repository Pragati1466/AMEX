...
> **No PostgreSQL needed!** The app now uses SQLite by default — zero database setup required.
...
4. **Select** your forked repo (e.g., `igdtuw-1/AMEX`)
5. **Blueprint Path**: leave as `render.yaml`
6. **Click** "Apply"
...
### Step 3: No env vars needed!

The `render.yaml` already has everything configured:
- ✅ `DATABASE_URL` = `sqlite:///./disputiq.db` (no PostgreSQL needed)
- ✅ `SECRET_KEY` = Auto-generated by Render
- ✅ Everything else is pre-set

**Just click "Apply" and wait 2 minutes — that's it!**
